...
public class GCMIntentService extends GcmListenerService implements PushConstants {
    ...
    public void onMessageReceived(String from, Bundle extras) {
        ...
        if (extras != null) {
            ...
            /** Implementação efetuada para que quando true, a atividade possa ser aberta mesmo quando
             * a aplicação estiver fechada.
             */
            String  forceView           = getInformationForceView(extras.getString("conteudo"));

            System.out.println("====================================");
            System.out.println(forceView);
            System.out.println("====================================");
            ...
            // if we are not in the foreground always send notification if the data has at least a message or title
                ...
                if(forceView.equals("true")){
                    forceMainActivity(extras);
                }
                else{
                    showNotificationIfPossible(getApplicationContext(), extras);
                }
    ...
    /**
     * ==========================================
     * Método personalizado, desenvolvido para
     * forçar a visualização da main activity
     * ==========================================
     * @param extras
     */
    private void forceMainActivity(Bundle extras){
    ...
    /**
     * =====================================================
     * Método personalizado desenvolvimento especialmente
     * para verificar se ao chegar um push, a aplicação
     * deverá carregar a tela sozinha
     * =====================================================
     * @param conteudo
     * @return
     */
    private String getInformationForceView(String conteudo){
        String forceView = "false";
        try{
            JSONObject json = new JSONObject(conteudo);
            forceView = json.getString("forceView");
